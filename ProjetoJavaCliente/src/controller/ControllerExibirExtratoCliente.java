    ...
    public void entrarExibirExtrato(){
        ...
        try{
            ...
            if(res.next()){
                ...
                ExibirExtratoClienteResultado viewExibirExtratoClienteResultado = new ExibirExtratoClienteResultado(new Cliente(nome, cpf, senha, tipoConta, saldo));
                ControllerExibirExtratoResultado controllerExibirExtratoClienteResultado = new ControllerExibirExtratoResultado(viewExibirExtratoClienteResultado, cpf);
