    ...
    public void entrarClienteDeposito(){
        ...
        try{
            ...
            if(res.next()){
                ...
                DepositarClienteValor viewDepositarClienteValor = new DepositarClienteValor(new Cliente(nome, cpf, senha, tipoConta, saldo));
                ControllerDepositarClienteValor controllerDepositarValor = new ControllerDepositarClienteValor(viewDepositarClienteValor, cpf);
